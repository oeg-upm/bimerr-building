...
<table style="width:100%; border: 1px solid">
  ...
  <tr>
    <td style="width:5%"></td>
    <td>The purpose of this model is to represent the main topological relationships that exists between entities in the building domain. Furthermore, the model aims to represent the main components and systems directly involved in energy related aspects of buildings.</td>
  </tr>
  ...
  <tr>
    <td style="width:5%"></td>
    <td>The scope of this ontology is limited to the building data shared through the BIF.</td>
  </tr>
  ...
  <tr>
    <td style="width:5%"></td>
    <td>BIM Manager Platform application.<br>
		RenoDSS application.<br>
        ARIBFA application.<br>
        BICA application.</td>
  </tr>
  ...
  <tr>
    <td style="width:5%"></td>
    <td>Exchange of data about buildings.</td>
  </tr>
...
<tr>
  ...
  <tr>
    <td style="width:5%"></td>
    <td>The whole set of functional requirements is located <a href="https://github.com/oeg-upm/bimerr-building/blob/master/requirements">here</a> </td>
  </tr>
